...
<?php
    ...
    if(((string)$_SESSION['tabela']) != 'modelos'){
...
<head>
    ...
    <body>
        ...
        <main>
            <h1 class="section-title">Editar Modelos</h1>
            <div class="tabela-editavel">
                ...
                <div id="tutorial" display="block">
                    ...
                    <text>Certifique-se de que o arquivo se encontra em: <br> secultintranet/arquivos/documentos/modelos</text>
                </div>
            </div>
