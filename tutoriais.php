...
<html>
    <head>
        <title>Intranet SECULT | Tutoriais</title>
    ...
    <body>
        ...
        <main>
            <h1 class="section-title">Tutoriais</h1>
...
<!-- geracao lista tutoriais -->
                <?php 
                    ...
                    $sql = ("SELECT nome, nome_arquivo FROM tutoriais ORDER BY id");
                    ...
                    if ($result = $conn->query($sql)) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo "<li class='topico'><a href='arquivos/documentos/tutoriais/" . $row['nome_arquivo'] . "' target='_blank'>" . $row['nome'] . "</a></li>\n";
