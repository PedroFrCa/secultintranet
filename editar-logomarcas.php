...
<?php
    ...
    if(((string)$_SESSION['tabela']) != 'logomarcas'){
...
<head>
    ...
    <body>
        ...
        <main>
            <h1 class="section-title">Editar Logomarcas</h1>
            <div class="tabela-editavel">
                ...
                <div id="tutorial" display="block">
                    ...
                    <text>Certifique-se de que o arquivo se encontra em: <br> secultintranet/arquivos/logomarcas</text>
                </div>
            </div>
