<?php
    ...
    if(((string)$_SESSION['tabela']) != 'suporte'){
...
<head>
    ...
    <body>
        ...
        <main>
            <h1 class="section-title">Editar Suporte</h1>
            <div class="tabela-editavel">
                ...
                <div id="tutorial" display="block">
                    ...
                    <text>Certifique-se de que a logo se encontra em: <br> secultintranet/arquivos/suporte</text>
                </div>
            </div>
